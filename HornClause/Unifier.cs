...
namespace HornClause
{
    ...
    public static class Unifier
    {
        ...
        {
            object de_a = Dereference(a, subst);
            object de_b = Dereference(b, subst);
            unifyingSubst = subst;
            ...
            else if (de_a is Variable x)
            {
                unifyingSubst = new Substitution(x, de_b, subst);
                return true;
            }
            else if (de_b is Variable y)
            {
                unifyingSubst = new Substitution(y, de_a, subst);
                return true;
            }
            else
            {
